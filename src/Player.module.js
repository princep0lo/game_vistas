  ...
  return (
    <>
      <div className={[player.player, props.viewMode].join(" ")} onMouseEnter={() => props.setShowButtons("")} onMouseLeave={() => props.setShowButtons(player.hideButton)}>
        ...
        <img className={player.mainImage} src={process.env.PUBLIC_URL + "/assets/images/" + props.shortTitle + "/" + props.shortTitle + " (" + props.selectedImage + ").jpg"} alt="" onClick={() => props.toggleZoomImage(true)} />
      ...
      {props.zoomImage && <img className={player.zoomImage} src={process.env.PUBLIC_URL + "/assets/images/" + props.shortTitle + "/" + props.shortTitle + " (" + props.selectedImage + ").jpg"} alt="" onClick={() => props.toggleZoomImage(false)} />}
    </>
  );
};
